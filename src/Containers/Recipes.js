...
//   }
  ...
  // const dataProcess = (recipeResult) => {
  ...
  //       "attachment": recipe.strMealThumb,
  //       "createdAt": 12345678,
  //       "ingredients": []
  //     }
  //     recipe
  ...
  const handleSearch = () => {
    ...
    // const recipeList = dataProcess(recipeResult)

    // let newData = recipeList.filter((item)=>{
    //   for (let key in item) {
  ...
  return(
    <Container style={{marginTop:'100px', marginBottom:'50px'}}>
      ...
      {selectedRecipe
        ?<RecipeCard recipe={selectedRecipe} setRecipe={setSelectedRecipe} attachment={attachment} expended={true} setAttachment={setAttachment} editable={isEditable} />
        : (
